# -*- coding: utf-8 -*-
"""
Created on Fri Aug 16 16:41:40 2019
...
def sub_on_line(train_, valid_, doc_path, is_shuffle=True):
    ...
    valid_res = pd.read_csv(open(data_path+'test_tag_r11.csv', encoding='utf8'))[['UID']]
...
if __name__ == '__main__':
    ...
    sub_on_line(train_stat, valid_stat, data_path+'gen_data/result/submit_a_lgb.csv')
